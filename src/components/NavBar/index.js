      ...
      <div className="flex-1 flex-col flex">
        <div className="flex-1">
          <NavLink
            ...
            to="/dashboard/new"
            className="p-4 border-b border-blue-400 cursor-pointer flex flex-row items-center"
          >
            <MdDashboard className="text-xl text-blue-400" />
            <span className="ml-4 text-xl">Gọi vốn</span>
          </NavLink>
          ...
          >
            ...
            <span className="ml-4 text-xl">Đầu tư</span>
          </NavLink>
          ...
          >
            ...
            <span className="ml-4 text-xl">Các dự án</span>
          </NavLink>
        </div>
        <div className="text-lg">
          Thời gian hiện tại{' '}
          <span className="font-bold">
            {moment(Number(moment().format('x')) + time).format('DD/MM/YYYY')}
          </span>
        </div>
